...
### 🧪 Running the Test
Fire up `TestBank.java`. It will set up two accounts, move $25,000 between them across 4 threads, and then print the final balances and the time it took to finish.
